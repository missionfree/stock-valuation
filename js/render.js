...
var MARKET_NEWS_KEYWORDS = [
  ...
  '国债', '收益率', '汇率', '人民币',
  // 政策主线7大主题
  '数字经济', '数据要素', '数据资产', '数字中国', '东数西算',
  '先进制造', '智能制造', '高端制造', '工业母机', '专精特新', '新型工业化',
  '生物医药', '创新药', '医疗器械', 'CXO', '基因治疗',
  '绿色低碳', '碳中和', '碳达峰', '绿电', '碳排放', '碳交易',
  '银发经济', '养老', '适老化', '康养', '智慧养老',
  '现代农业', '乡村振兴', '种业', '转基因', '智慧农业', '粮食安全',
  '低空经济', 'eVTOL', '无人机', '飞行汽车', '通用航空'
];
...
var NEWS_BULL_KEYWORDS = {
  ...
  // 政策主线利好词
  '振兴': 2, '培育': 2, '商业化': 2, '出海': 2, '适航': 2,
  '示范区': 1, '试点扩围': 2, '投产': 1, '放量': 1, '突破': 1,
  '战略新兴产业': 2, '顶层设计': 2, '行动方案': 2, '专项债': 1
};
