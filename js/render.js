...
var LI_DAXIAO_QUOTES = {
  ...
  // 国家队入驻（持仓稳定/不变）
  nationalTeamHold: [
    { q: '国家队就在这里，不要恐慌', sub: '国家队驻守如定海神针，底部信号明确' },
    { q: '紧跟汇金走，吃喝啥都有', sub: '国家队持仓稳定，安心持有好股' },
    { q: '跟着国家走，跟着大股东走，吃喝啥都有', sub: '国家队坐镇，方向不会错' },
    { q: '中央汇金的入场就是定海神针', sub: '有国家队在，好股更安心' },
    { q: '国家队的护盘资金终将到来', sub: '国家队坚守阵地，底部就在脚下' },
    { q: '保护散户、爱护散户、捍卫散户，让散户赚到钱', sub: '国家队在场，散户不必恐慌' },
    { q: '好股票就是要拿住，国家队都在你还怕什么', sub: '国家队持仓不变，坚定持有' },
    { q: '钻石底亮晶晶，国家队在这里', sub: '国家队持仓就是最好的底部确认' }
  ],
  // 国家队加仓
  nationalTeamIncrease: [
    { q: '国家队就在这里！汇金增持就是最大的信心保障', sub: '国家队加仓释放强烈底部信号' },
    { q: '紧跟汇金走，吃喝啥都有', sub: '国家队逆势加仓，聪明资金已入场' },
    { q: '汇金增持了，你们还怕什么', sub: '国家队用真金白银投票，底部已现' },
    { q: '跟着国家队走，错不了', sub: '国家队加仓方向就是未来的方向' },
    { q: '保护散户、爱护散户、捍卫散户', sub: '国家队出手加仓护盘，散户莫恐慌割肉' },
    { q: '底部又被国家队抄走了，内资太过悲观', sub: '国家队加仓时机精准，跟紧步伐' },
    { q: '钻石底亮晶晶，国家队在这里加仓', sub: '国家队加仓确认底部，安心持有' },
    { q: '国家队的入场就是最好的做多信号', sub: '汇金证金齐加仓，底部就在脚下' }
  ],
  // 国家队减仓
